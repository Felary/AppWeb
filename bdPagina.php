<?php
// PHP PDO (PHP Data Objects) es un conjunto de clases que permite interactuar con diferentes bases de datos
$servidor = "127.0.0.1";
$usuario = "root";
$contraseña = "";

// Se crea el bloque try-catch para manejar las excepciones
try {
    // Se crea la conexión a la base de datos con PDO y se le pasa el servidor, la base de datos, el usuario y la contraseña 
    $conexion = new PDO("mysql:host=$servidor;dbname=hamburgueseria", $usuario, $contraseña);
    // Se establece el modo de error a excepción para que muestre los errores
    $conexion->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    // Se muestra un mensaje de conexión exitosa
